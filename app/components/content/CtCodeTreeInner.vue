<template>
  <Card
    class="overflow-clip py-0 gap-0 rounded-lg bg-card shadow-xs lg:grid lg:grid-cols-3 not-first:mt-5"
  ...
  >
    <div class="border-b lg:border-b-0 lg:border-r">
      ...
      <ScrollArea :style="[`height: ${title ? height : height + 45}px`]">
        <CtCodeTreeRoot :id :default-value="defaultValue" :tree :level="0" class="p-2!" />
      </ScrollArea>
    </div>
