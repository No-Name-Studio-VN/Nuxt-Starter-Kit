<template>
  <Card class="py-0 gap-0 rounded-lg bg-card shadow-xs">
    <CardHeader class="flex flex-col gap-y-1.5 p-6">
      <div class="flex flex-col gap-3" :class="{ 'text-center': center }">
        <Avatar class="size-10" :class="{ 'mx-auto': center }">
