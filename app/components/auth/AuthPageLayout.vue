...
const props = withDefaults(defineProps<{
  ...
  quote: 'A starter should give you strong defaults without hiding the logic you need to own.',
...
<template>
  <main class="relative h-[100dvh] overflow-hidden bg-background lg:grid lg:grid-cols-2">
    ...
    <section class="relative flex h-full min-h-0 flex-col overflow-x-hidden overflow-y-auto px-4 py-20 sm:px-6 lg:px-10">
      ...
      >
        <div class="absolute right-0 top-0 size-80 -translate-y-1/2 translate-x-1/4 rounded-full bg-foreground/[0.04] blur-3xl" />
        <div class="absolute bottom-0 left-0 size-72 translate-y-1/3 rounded-full bg-muted blur-3xl" />
      </div>
      ...
      <div class="mx-auto my-auto flex w-full max-w-sm flex-col gap-5">
