...
autoSlash: false
showArrow: true
tree: - app: - assets/css: null - components: null - composables: null - constants: null - layouts: null - lib: null - middleware: null - pages: null - plugins: null - public: null - server: - api: null - database: null - utils: null - types: null - nuxt.config.ts - pwa.config.ts
