...
description: A guide to set up internationalization (i18n) for your Nuxt Starter Kit
---
...
tree: - content: - index.md - xx: - index.md
---
...
export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      // Add here all english strings defined in docs.config.ts e.g. titles in header.nav or toc.title
...
- `vi` (Tiếng Việt)
  ...
  ::ct-alert{icon="lucide:git-pull-request-arrow" to="https://github.com/No-Name-Studio-VN/Homepage/issues"}
  If you want to add more UI locales, feel free to contribute to the project.
  ::

Or if you want to add your own translations, you can do so by following the structure in the [`i18n/i18n.config.ts`](https://github.com/No-Name-Studio-VN/Homepage/blob/main/i18n/i18n.config.ts) file. Just add the translations for the keys you want to translate in the respective language object.
