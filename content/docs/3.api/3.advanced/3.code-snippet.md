...
::ct-alert{icon="lucide:triangle-alert" type="danger"}
...
::ct-code-snippet
---
url: https://raw.githubusercontent.com/No-Name-Studio-VN/Homepage/refs/heads/main/pages/index.vue
language: vue
---
::
```
...
::ct-field-group
:ct-field{name="file" type="string"}[The path to the imported file]
:ct-field{name="url" type="string"}[A remote URL to fetch the code from]
:ct-field{name="title" type="string"}[Code block title]
:ct-field{name="language" type="string"}[Code block highlight language]
:ct-field{name="highlights" type="string"}[Code block highlights lines]
:ct-field{name="meta" type="string"}[Code block meta]
:ct-field{name="start" type="number"}[Starting line index]
:ct-field{name="offset" type="number"}[Number of lines to display from start]
::
